...
export class NotLambdaService {
  private async getPdfFromPuppeter(contrato:{
    senderName:string,
    ...
    >
      <head>
        ...
        <title>Contrato de negocio</title>
        <!--[if (mso 16)
          ]><style type="text/css">
            a {
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <tr>
                                      ...
                                      color: #333333;
                                      font-size: 14px;">
                                      ${contrato.proposalNumber} - ${contrato.proposalShortDescription}</p>
                                    <p                                       
                                    style="
                                    margin: 0;
                                    -webkit-text-size-adjust: none;
                                    ...
                                    color: #333333;
                                    font-size: 14px;">
                                    ${contrato.clientName} - ${contrato.clientCompany}</p>
                                        <p
                                          style="
                                            margin: 0;
                                            -webkit-text-size-adjust: none;
                                          ...
                                          "
                                        >
                                          <br />${contrato.proposalIntroduction}
                                        </p>
                                        <p
                                        style="
                                          margin: 0;
                                    ...
                                    "
                                  >
                                    <br />${contrato.senderName},<br />${contrato.senderEmail}<br />${contrato.senderTel}<br />${contrato.senderSite}, ${contrato.senderLocation}
                                  </p>
                                      </td>
                                    </tr>
                                  </table>
   ...
   * @param contrato
   */
  public async buildPdf(contrato: { 
    senderName: string,
    senderCompany:string,
    senderSlogan:string,
    senderTel:string,
